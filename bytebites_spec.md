...
1. **Customer** - Represents app users, storing their names and purchase history
2. **Item** - Represents individual food items with properties (name, price, category, popularity rating)
3. **Menu** - Manages the collection of all items and provides filtering capabilities by category
4. **Transaction** - Groups selected items together and computes the total cost
